...
const ImpactSection = ({
  ...
  const stats = ["87% dos experts usam IA como braço (e cobram 2k)", "13% usam como cérebro (e cobram 30k+)", "A diferença? Como vendem seus serviços."];
  return <section className="py-20 bg-vanguardia-black text-vanguardia-white relative overflow-hidden">
      {/* Background pattern */}
      <div className="absolute inset-0 opacity-10">
        <div style={{
        backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23ffffff' fill-opacity='0.1'%3E%3Ccircle cx='30' cy='30' r='4'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`
      }} className="w-full h-full bg-repeat bg-vanguardia-blue"></div>
      </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="animate-fade-in">
              ...
              <div className="space-y-4 mb-8">
                {stats.map((stat, index) => <div key={index} className="flex items-start gap-3 animate-slide-in" style={{
              ...
              <div className="relative">
                <div className="w-80 h-96 bg-gradient-to-br from-vanguardia-blue/20 to-purple-500/20 rounded-2xl border border-vanguardia-blue/30 backdrop-blur-sm overflow-hidden">
                  ...
                  <div className="relative h-full">
                    <img src="/lovable-uploads/7d292775-fbe4-47a2-8b87-4a311f94dd8f.png" alt="Jorge Antonio Auad Filho - CEO Grupo Vanguardia" className="w-full h-full object-cover object-center" />
