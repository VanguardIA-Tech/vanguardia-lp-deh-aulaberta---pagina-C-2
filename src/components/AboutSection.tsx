...
const AboutSection = ({
  ...
  return <section className="py-12 sm:py-16 md:py-20 lg:py-24 bg-gradient-to-br from-vanguardia-black via-vanguardia-dark-blue to-vanguardia-medium-blue relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-20 sm:-bottom-40 -left-20 sm:-left-40 w-60 h-60 sm:w-80 sm:h-80 bg-vanguardia-blue/15 rounded-full blur-3xl animate-pulse-glow" style={{
        animationDelay: '1s'
      }}></div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="space-y-4 sm:space-y-6 mb-8 sm:mb-10">
                {credentials.map((credential, index) => <div key={index} className="flex items-start gap-3 sm:gap-4 animate-slide-in bg-vanguardia-white/5 p-3 sm:p-4 rounded-lg border border-vanguardia-blue/20 hover:border-vanguardia-blue/40 transition-all duration-300 hover:shadow-lg backdrop-blur-sm" style={{
              ...
              <div className="text-center lg:text-left">
                <Button onClick={onOpenModal} size="lg" className="w-full sm:w-auto bg-vanguardia-blue hover:bg-vanguardia-blue/90 text-vanguardia-white px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-semibold transition-all duration-300 transform hover:scale-105 vanguardia-blue-glow font-funnel border-0 rounded-xl uppercase tracking-wide">
